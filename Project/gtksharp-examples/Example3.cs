...
Animated windows can be achieved by using a timer to repeatedly redraw the scene.
...
class Example3
{
	static void Main()
	{
      ...
      drawingarea.SetSizeRequest(100, 260);
		...
		// Start the timer to refresh the DrawingArea animation using GLib.Timeout
		GLib.Timeout.Add(1000 / FPS, () =>
		{
